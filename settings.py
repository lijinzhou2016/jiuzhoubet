...
POSITON_FIFTH_ODDS = '1'
POSTION_FOURTH_ODDS = '2'
POSTION_THIRD_ODDS = '3'
POSTION_SECOND_ODDS = '4'
POSTION_FIRST_ODDS = '5'
...
# 获取时时彩投注号码接口
BET_CODE_URL = 'http://47.104.31.179/project/PredictionResultServlet?phone={0}&period='
